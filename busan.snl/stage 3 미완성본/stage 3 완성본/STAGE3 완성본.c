...
void move_citizen0() {
    ...
    if (citizen0_escaped) return; // 이미 탈출한 시민은 움직이지 않음
    ...
    if (citizen0 == 0) { // 시민이 위치 1에 도달하면 탈출
        printf("Citizen 0 has escaped!\n");
        citizen0 = -1; // 비활성화
        citizen0_escaped = 1; // 시민 0이 탈출했음을 표시
        remaining_citizens--;
    }
}
...
void move_citizen1() {
    ...
    if (citizen1_escaped) return; // 이미 탈출한 시민은 움직이지 않음
    ...
    if (citizen1 == 0) { // 시민이 위치 1에 도달하면 탈출
        printf("Citizen 1 has escaped!\n");
        citizen1 = -1; // 비활성화
        citizen1_escaped = 1; // 시민 0이 탈출했음을 표시
        remaining_citizens--;
    }
}
...
void move_citizen2() {
    ...
    if (citizen2_escaped) return; // 이미 탈출한 시민은 움직이지 않음
    ...
    if (citizen2 == 0) { // 시민이 위치 1에 도달하면 탈출
        printf("Citizen 2 has escaped!\n");
        citizen2 = -1; // 비활성화
        citizen2_escaped = 1; // 시민 0이 탈출했음을 표시
        remaining_citizens--;
    }
}
